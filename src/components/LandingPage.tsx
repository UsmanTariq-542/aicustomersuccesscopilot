...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* ── Hero ── */}
      <section className="flex flex-col items-center justify-center px-4 pt-24 pb-20 sm:pt-32 sm:pb-28 text-center">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base sm:text-lg text-foreground/60 max-w-xl mx-auto leading-relaxed">
